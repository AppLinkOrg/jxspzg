...
export class InstApi{
    ...
    commoditytype(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/commoditytype',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    typeinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'inst/typeinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
